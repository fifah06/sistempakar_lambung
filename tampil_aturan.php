<div class="table-responsive">
  <div class="card">
    <div class="card-header text-white border-dark" style="background-color: #14b8b8"><strong>DATA BASIS ATURAN</strong></div>
        <div class="card-body">
            <a class="btn mb-2" style="background-color: #14b8b8" href="?page=aturan&action=tambah">Tambah</a>
    ...
    <tbody>
            ...
            <?php
                ...
                $sql = "SELECT basis_aturan.idaturan,basis_aturan.idpenyakit,
                        penyakit.kdpenyakit,penyakit.nmpenyakit,penyakit.keterangan FROM basis_aturan INNER JOIN penyakit 
