    ...
    <div class="col-sm-12">
        <form action="" method="POST">
            <div class="card border-dark">
                <div class="card">
                    <div class="card-header text-white border-dark" style="background-color: #14b8b8"><strong>DETAIL HALAMAN BASIS ATURAN</strong></div>
	                <div class="card-body">
                    <div class="form-group">
                            <label for="">Kode Penyakit</label>
                            <input type="text" class="form-control" value="<?php echo $row['kdpenyakit'] ?>" name="kode" readonly>
   	                    </div>
                        <div class="form-group">
                        ...
                        <!-- tabel gejala-gejala -->
                        <label for="">Gejala-Gejala Penyakit Lambung</label>
