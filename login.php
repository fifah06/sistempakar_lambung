...
<h5 style="text-align: center;">Sistem Pakar Diagnosa Penyakit Lambung</h5>
    <div class="row">
            ...
            <form method="POST">
                <div class="card border-dark">
                    ...
                    <div class="card-body border">
                        ...
                        <input type="submit" class="btn btn-block "style="background-color: #14b8b8" name="submit" value="Login">
                        <div class="links">
